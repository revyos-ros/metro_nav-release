...
Name:           ros-humble-base2d-kinematics
Version:        0.2.0
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS base2d_kinematics package

License:        BSD 3-clause
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-humble-base2d-kinematics-msgs
Requires:       ros-humble-geometry-msgs
Requires:       ros-humble-nav-2d-msgs
Requires:       ros-humble-rclcpp
Requires:       ros-humble-ros-workspace
BuildRequires:  ros-humble-ament-cmake
BuildRequires:  ros-humble-base2d-kinematics-msgs
...
%changelog
* Fri Sep 08 2023 David V. Lu!! <davidvlu@gmail.com> - 0.2.0-1
